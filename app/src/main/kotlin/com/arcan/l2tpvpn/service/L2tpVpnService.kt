...
import com.arcan.l2tpvpn.core.tunnel.L2tpIpsecTunnel
...
import com.arcan.l2tpvpn.core.tunnel.TunnelListener
import com.arcan.l2tpvpn.core.tunnel.TunnelState
import com.arcan.l2tpvpn.core.tunnel.TunnelStats
import com.arcan.l2tpvpn.core.util.Log
import com.arcan.l2tpvpn.core.util.LogLevel
import com.arcan.l2tpvpn.data.ProfileRepository
import com.arcan.l2tpvpn.data.VpnProfile
import com.arcan.l2tpvpn.data.validate
import com.arcan.l2tpvpn.label
import com.arcan.l2tpvpn.platform.AndroidLogger
import com.arcan.l2tpvpn.platform.AndroidTunProvider
import com.arcan.l2tpvpn.platform.AndroidUdpSocketFactory
...
class L2tpVpnService : VpnService() {
    ...
    companion object {
        ...
        const val ACTION_CONNECT = "com.arcan.l2tpvpn.action.CONNECT"
        const val ACTION_DISCONNECT = "com.arcan.l2tpvpn.action.DISCONNECT"
