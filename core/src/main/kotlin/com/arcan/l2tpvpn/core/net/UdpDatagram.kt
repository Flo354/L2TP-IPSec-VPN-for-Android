 ...
 * have to build that datagram ourselves before handing it to [com.arcan.l2tpvpn.core.esp.EspOutboundSa].
 */
object UdpDatagram {
     ...
     * directly instead of through a [com.arcan.l2tpvpn.core.util.ByteReader], because this runs
