...
import com.arcan.l2tpvpn.core.esp.EspException
import com.arcan.l2tpvpn.core.esp.EspInboundSa
import com.arcan.l2tpvpn.core.esp.EspOutboundSa
import com.arcan.l2tpvpn.core.esp.UdpEncapsulation
import com.arcan.l2tpvpn.core.ike.IkeTransport
import com.arcan.l2tpvpn.core.ike.IkeV1Negotiator
import com.arcan.l2tpvpn.core.ike.NatTraversalFlavor
import com.arcan.l2tpvpn.core.ike.Phase1Result
import com.arcan.l2tpvpn.core.ike.Phase2Result
import com.arcan.l2tpvpn.core.l2tp.L2tpTransport
import com.arcan.l2tpvpn.core.l2tp.L2tpTunnel
import com.arcan.l2tpvpn.core.net.UdpDatagram
import com.arcan.l2tpvpn.core.ppp.PppFrame
import com.arcan.l2tpvpn.core.ppp.PppProtocol
import com.arcan.l2tpvpn.core.ppp.PppSession
...
class L2tpIpsecTunnel(
    ...
    private fun negotiatePpp(l2tp: L2tpTunnel, ppp: PppSession): com.arcan.l2tpvpn.core.ppp.PppResult {
        ppp.start()
